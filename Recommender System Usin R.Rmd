...
wordcloud(keywords_counts$keyword, keywords_counts$n, max.words = 100, scale=c(1.0,.5), random.color = TRUE, random.order=FALSE, rot.per=0, colors=brewer.pal(9,"Set1"))
